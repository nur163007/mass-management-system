...
class ExpanseController extends Controller
{
    ...
    public function viewExpanse(){
        ...
        // dd("ok");
         $bazars = DB::select("SELECT ex.id,ex.invoice_no,ex.total_amount as total, ex.date as expanse_date,m.full_name
                                FROM expanses ex
...
// dd($all_details);
    ...
    //     // dd($id);
    //     $expanses_details = ExpanseDetails::findOrFail($id);
    //     // dd($expanses_details);
    //     if($expanses_details){
    //         $expanses_details->delete();
    ...
    //     }
    // }
    // public function showExpanse(){
    //     $bazar = DB::table('expanses')
    //     ->join('members','expanses.member_id','members.id')
    //     ->join('food_categories','expanses.category_id','food_categories.id')
    //     ->join('food_items','expanses.item_name_id','food_items.id')
    //     ->select('expanses.*','members.full_name','food_categories.category_name','food_items.*')
    //     ->get();
    //     // dd($bazar);
    //     return view('admin.expanse.viewExpanse',compact('bazar'));
    // }
}
