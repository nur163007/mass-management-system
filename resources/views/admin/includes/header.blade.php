    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <div class="nav-link" data-toggle="dropdown" href="#">
            <img src="{{ asset('uploads/members/profile/' . session()->get('profile')) }}" class="img-circle elevation-2" style="height:38px;width:38px; border-radius:50%; margin-top:-10px;"alt="User Image">
