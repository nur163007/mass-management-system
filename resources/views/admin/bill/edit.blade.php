                    ...
                    <form action="{{ route('admin.bill.update', $bill->id) }}" method="POST" id="form">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12" id="extra_gas_users_field" style="display: {{ $bill->bill_type == 'gas' ? 'block' : 'none' }};">
                                ...
                                <select class="form-control select2bs4" id="extra_gas_users" name="extra_gas_users[]" multiple autocomplete="off">
                                    ...
                                    @foreach($members as $member)
                                        <option value="{{ $member->id }}" {{ in_array($member->id, $extraUsers) ? 'selected' : '' }}>
                                            {{ $member->full_name }} 
                                            @if($member->role_id == 2)
                                                (Manager)
                                            @endif
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" class="form-control" id="bill_date" name="bill_date" value="{{ $bill->bill_date ? date('Y-m-d', strtotime($bill->bill_date)) : date('Y-m-d') }}" required autocomplete="off">
