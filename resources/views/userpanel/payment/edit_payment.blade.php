...
@section('heading', 'User edit-payment')
        ...
        <div class="card col-md-8 offset-md-2">
            <div class="row">
                <div class="card-header col-md-4 col-12">
                    <h3 class="font-weight-bolder">Edit Payment</h3>
                </div>
            ...
            <div class="card-body">
                <form method="POST"  enctype="multipart/form-data" id="form">
                    @csrf
                       <div class="row">               
                        <input type="hidden" value="{{ $payment->id}}" id="paymentID" name="paymentID">
                    
                           <div class="form-group col-md-6">
                               <label for="amount">Payment Amount</label>
                               <input class="form-control" type="number" id="amount" name="amount"value="{{$payment->payment_amount}}">
                           ...
                           <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="date" id="date" name="date" value="{{$payment->date}}">
